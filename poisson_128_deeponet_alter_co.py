...
def pre_train_fu(Ntr, file_number, relative_fno_model_directory):
    ...
    file_path = 'deeponet_poisson_128_f_2_u_model.pth'
    torch.save({
...
def train_PPI_f_u_model(Ntr, loop_num, pre_fno_error_list, ppi_fno_error_list, epochs, lam, batch_size, model_directory,
    ...
    model_fu = DeepONet(branch_dim, trunk_dim).float().cuda()
    checkpoint_fu = torch.load('deeponet_poisson_128_f_2_u_model.pth')
    ...
    if file_num == 5 and loop_num == num_iteration - 1:
...
if __name__ == '__main__':
    ...
    print("5,10,20,30 poisson_128 deeponet_pretrain mean error:", pre_fno_mean_record)
    print("5,10,20,30 poisson_128 deeponet_pretrain std error:", pre_fno_std_record)
