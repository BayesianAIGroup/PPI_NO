...
def pre_train_fu(Ntr, file_number, relative_fno_model_directory):
    ...
    file_path = 'fno_crack_128_f_2_u_model.pth'
    file_path2 = 'fno_crack_128_f_2_u_model_stan_fno.pth'
    torch.save({
...
def train_PPI_f_u_model(Ntr, loop_num, pre_fno_error_list, ppi_fno_error_list, epochs, lam, batch_size, model_directory,
    ...
    # load fu
    model_fu = FNO2d(modes, modes, width, s).float().cuda()
    checkpoint_fu = torch.load('fno_crack_128_f_2_u_model.pth')
...
if __name__ == '__main__':
    ...
    print("400, 500, 600 crack_128 fno_pretrain mean error:", pre_fno_mean_record)
    print("400, 500, 600 crack_128 fno_pretrain std error:", pre_fno_std_record)
